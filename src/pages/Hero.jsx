    ...
    <Section>
      <div className="flex flex-col items-center relative py-[2rem] justify-between gap-[2rem] lg:flex-row-reverse lg:py-[1rem]">
        ...
        <div className="flex flex-col gap-1 lg:gap-[0.5rem] relative lg:pe-[2rem] lg:ps-[1rem] bg-gra">
          <p className="text-2xl lg:text-5xl">Hi There,</p>

          <div className="relative">
            <p className="text-[2.3rem] lg:text-[70px] font-montserrat font-semibold bg-gradient-to-r from-purple-600 via-purple-400 to-blue-600 bg-clip-text text-transparent">
              <Typewriter
                options={{
